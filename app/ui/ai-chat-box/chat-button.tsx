...
export function ChatButton() {
  ...
  return (
    <>
      <button
        className="flex items-center group text-white font-bold md:border-2 md:rounded-full px-1 md:px-2 md:py-3 border-[#848081] hover:border-emerald-400 transition-colors"
